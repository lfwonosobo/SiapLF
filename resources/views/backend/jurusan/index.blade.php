...
{!! Breadcrumbs::render('jurusan'); !!}
                <div class="page-header">
                    <h1>
                        {{$title}} <br />
                        <small>Menambahkan Jurusan yang tersedia di LF Wonosobo</small>
                    </h1>
                </div>
                                ...
                                <tr ng-repeat="status in data| filter:paginate">
                                    ...
                                    <td class="center">
                                        <div class="visible-md visible-lg hidden-sm hidden-xs">
                                            <a data-original-title="Siswa" data-placement="top" class="btn btn-xs btn-success tooltips" href="{{url('admin/jurusan')}}/<% status['id_jurusan']%>/siswa"><i class="fa fa-user"></i> Lihat Siswa</a>
