...
@stop
@section('content')
<div class="main-content" ng-controller="pegawai">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="page-header">
                    <h1>
                        {{$title}} <br />
                        <small>Data Pegawai di situs website SMA Negeri 1</small>
                    </h1>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a class="btn btn-green add-row" href="{{route('admin.pegawai.create')}}">
